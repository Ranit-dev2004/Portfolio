import{r,d as R,e as y,t as L,W as C,L as E,P as I,f as M,v as j,U as q,w as A,i as D,D as G,A as F,j as z}from"./entry.client-g4LGL3oA.js";import{a as T,u as U}from"./image-C37Vwfgw.js";import{m as P,T as V}from"./heading-CxbOS-bD.js";import{u as k}from"./useWindowSize-BiKi-vjD.js";import{c as H,a as W,r as N,t as B}from"./three-Cv03_sgO.js";import"./button-C1QwbVqQ.js";const O=`#define PHONG\r
\r
...
`,Y="_canvas_1pqfq_1",J={canvas:Y},h={stiffness:30,damping:20,mass:2},en=w=>{const{theme:u}=T(),b=r.useRef(Date.now()),d=r.useRef(),S=r.useRef(),c=r.useRef(),o=r.useRef(),a=r.useRef(),m=r.useRef(),g=r.useRef(),p=r.useRef(),x=r.useRef(),t=r.useRef(),s=R(),l=U(d),_=k(),v=y(0,h),f=y(0,h);return r.useEffect(()=>{const{innerWidth:n,innerHeight:e}=window;return S.current=new L(.8,.5),c.current=new C({canvas:d.current,antialias:!1,alpha:!0,powerPreference:"high-performance",failIfMajorPerformanceCaveat:!0}),c.current.setSize(n,e),c.current.setPixelRatio(1),c.current.outputColorSpace=E,o.current=new I(54,n/e,.1,100),o.current.position.z=52,a.current=new M,p.current=new j,p.current.onBeforeCompile=i=>{g.current=q.merge([i.uniforms,{time:{type:"f",value:0}}]),i.uniforms=g.current,i.vertexShader=X,i.fragmentShader=O},r.startTransition(()=>{x.current=new A(32,128,128),t.current=new D(x.current,p.current),t.current.position.z=0,t.current.modifier=Math.random(),a.current.add(t.current)}),()=>{H(a.current),W(c.current)}},[]),r.useEffect(()=>{const n=new G(16777215,u==="light"?1.8:2),e=new F(16777215,u==="light"?2.7:.4);return n.position.z=200,n.position.x=100,n.position.y=100,m.current=[n,e],m.current.forEach(i=>a.current.add(i)),()=>{N(m.current)}},[u]),r.useEffect(()=>{const{width:n,height:e}=_,i=e+e*.3;c.current.setSize(n,i),o.current.aspect=n/i,o.current.updateProjectionMatrix(),s&&c.current.render(a.current,o.current),n<=P.mobile?(t.current.position.x=14,t.current.position.y=10):n<=P.tablet?(t.current.position.x=18,t.current.position.y=14):(t.current.position.x=22,t.current.position.y=16)},[s,_]),r.useEffect(()=>{const n=B(e=>{const i={x:e.clientX/window.innerWidth,y:e.clientY/window.innerHeight};v.set(i.y/2),f.set(i.x/2)},100);return!s&&l&&window.addEventListener("mousemove",n),()=>{window.removeEventListener("mousemove",n)}},[l,s,v,f]),r.useEffect(()=>{let n;const e=()=>{n=requestAnimationFrame(e),g.current!==void 0&&(g.current.time.value=5e-5*(Date.now()-b.current)),t.current.rotation.z+=.001,t.current.rotation.x=v.get(),t.current.rotation.y=f.get(),c.current.render(a.current,o.current)};return!s&&l?e():c.current.render(a.current,o.current),()=>{cancelAnimationFrame(n)}},[l,s,v,f]),z.jsx(V,{in:!0,timeout:3e3,nodeRef:d,children:({visible:n,nodeRef:e})=>z.jsx("canvas",{"aria-hidden":!0,className:J.canvas,"data-visible":n,ref:e,...w})})};export{en as DisplacementSphere};
